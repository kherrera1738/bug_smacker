...
class HistoriesTest < ApplicationSystemTestCase
  ...
  test "creating a History" do
    ...
    fill_in "Change type", with: @history.change_type
    fill_in "Changed by", with: @history.changed_by_id
    fill_in "New value", with: @history.new_value
    fill_in "Old value", with: @history.old_value
    fill_in "Ticket", with: @history.ticket_id
